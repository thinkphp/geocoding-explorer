...
<div id="doc3" class="yui-t7">
   <div id="hd" role="banner"><h1>Google Reverse Geocoding Explorer</h1></div>
   <div id="bd" role="main">
    <div class="yui-gc">
      ...
      <div class="yui-u">
           <form id="f" class="nonlive"><label for="earlier">Earlier Locations: </label> <select name="earlier" id="earlier"></select><input type="submit" value="Go"></form>
           <div id="info"><strong>doubleClick on Map to reverse geocoding</div>
      </div>
   </div>
 </div>
